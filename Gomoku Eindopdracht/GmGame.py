...
class GmGame:
    ...
    def start(player1, player2, max_time_to_move, showIntermediateMoves=True):
        ...
        TIEWINNERIMG = pygame.image.load("Gomoku Eindopdracht/assets/5row_tie.png").convert_alpha()
